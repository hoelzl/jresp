...
public class NotEqual implements IComparisonFunction{
		...
		public Boolean evaluateFunction(List<Object> args) throws Throwable {
			if (args.size() == 2){
				if (args.get(0) instanceof Boolean && args.get(1) instanceof Boolean){
					//BOOLEAN
				...
				}else if ((args.get(1) instanceof Double || args.get(1) instanceof Integer ) && (args.get(0) instanceof Double || args.get(0) instanceof Integer )){
					//DOUBLE
					if (!(args.get(0).equals(args.get(1)))){
						return true;
					}else{
				...
				}else if (args.get(0) instanceof Integer && args.get(1) instanceof Integer){
					//INTEGER
					if (!(args.get(0).equals(args.get(1)))){
						return true;
					}else{
				...
				}else  if (args.get(0) instanceof String && args.get(1) instanceof String){
					//STRING
					if (!(args.get(0).equals(args.get(1)))){
						return true;
					}else{
