...
public class SCELJsonUtil {
	...
	/**
	 * Json tag associated to generic objects. The type of the specific
	 * object is determined by relying on attribute {@link SCELJsonUtil#TYPE_ID}
	 */
	 ...
	 * <ul>
	 * <li> <code>type</code>, containing a string with the fully qualified
	...
	/**
	 * Deserialize an object from a {@link JsonElement}. We assume that the received
	 * JsonElement is a {@link JsonObject} providing two attributes:
	 * <ul>
	 * <li> <code>type</code>, containing a string with the fully qualified
	 * name of the serialized object;
	 * <li> <code>value</code>, containing the {@link JsonElement} associated to 
