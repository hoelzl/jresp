...
/**
 * This class is used to serialize a {@link Template}
 * into a {@link JsonElement} (see {@link JsonSerializer}).
 * 
...
public class TemplateSerializer implements JsonSerializer<Template> {
	...
	@Override
	public JsonElement serialize(Template src, Type typeOfSrc,
