...
/**
 * This class is used to deserialize an {@link ActualTemplateField}
 * from a {@link JsonElement} (see {@link JsonDeserializer}).
 * 
...
public class ActualTemplateFieldDeserializer implements JsonDeserializer<ActualTemplateField> {
	...
	@Override
	public ActualTemplateField deserialize(JsonElement json, Type typeOfT,
