...
/**
 * Manual modifications go to {org.cmg.resp.xtext.hlscel.HLScelRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractHLScelRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/cmg/resp/xtext/hlscel/HLScel.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.cmg.resp.xtext.hlscel.HLScel");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("scel");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.cmg.resp.xtext.hlscel.services.HLScelGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.cmg.resp.xtext.hlscel.serializer.HLScelSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.cmg.resp.xtext.hlscel.serializer.HLScelSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.cmg.resp.xtext.hlscel.parser.antlr.HLScelParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.cmg.resp.xtext.hlscel.parser.antlr.HLScelAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.cmg.resp.xtext.hlscel.parser.antlr.internal.InternalHLScelLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.cmg.resp.xtext.hlscel.parser.antlr.internal.InternalHLScelLexer> provideInternalHLScelLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.cmg.resp.xtext.hlscel.parser.antlr.internal.InternalHLScelLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.cmg.resp.xtext.hlscel.parser.antlr.internal.InternalHLScelLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.cmg.resp.xtext.hlscel.validation.HLScelValidator> bindHLScelValidator() {
		return org.cmg.resp.xtext.hlscel.validation.HLScelValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.cmg.resp.xtext.hlscel.formatting.HLScelFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.cmg.resp.xtext.hlscel.jvmmodel.HLScelJvmModelInferrer.class;
	}
