 ...
 */
class HLScelJvmModelInferrer extends AbstractModelInferrer {
	 ...
	 *            <code>true</code>.
	 */
   	def dispatch void infer(ProcessDeclaration process, IJvmDeclaredTypeAcceptor acceptor, boolean isPreIndexingPhase) {
