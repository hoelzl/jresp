...
* generated by Xtext
*/
package org.cmg.resp.xtext.hlscel.ui.contentassist.antlr;
...
public class HLScelParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.cmg.resp.xtext.hlscel.ui.contentassist.antlr.internal.InternalHLScelParser createParser() {
		org.cmg.resp.xtext.hlscel.ui.contentassist.antlr.internal.InternalHLScelParser result = new org.cmg.resp.xtext.hlscel.ui.contentassist.antlr.internal.InternalHLScelParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getHLScelActionAccess().getAlternatives(), "rule__HLScelAction__Alternatives");
					...
					put(grammarAccess.getNodeDeclarationAccess().getGroup(), "rule__NodeDeclaration__Group__0");
					put(grammarAccess.getNodeDeclarationAccess().getGroup_3(), "rule__NodeDeclaration__Group_3__0");
					put(grammarAccess.getNodeDeclarationAccess().getGroup_3_1(), "rule__NodeDeclaration__Group_3_1__0");
					...
					put(grammarAccess.getHLScelPredicateAccess().getGroup(), "rule__HLScelPredicate__Group__0");
					put(grammarAccess.getSelfLiteralAccess().getGroup(), "rule__SelfLiteral__Group__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_0(), "rule__HLScelAction__Group_0__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_0_4(), "rule__HLScelAction__Group_0_4__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_1(), "rule__HLScelAction__Group_1__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_1_4(), "rule__HLScelAction__Group_1_4__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_2(), "rule__HLScelAction__Group_2__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_2_4(), "rule__HLScelAction__Group_2_4__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_3(), "rule__HLScelAction__Group_3__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_3_4(), "rule__HLScelAction__Group_3_4__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_4(), "rule__HLScelAction__Group_4__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_4_4(), "rule__HLScelAction__Group_4_4__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_5(), "rule__HLScelAction__Group_5__0");
					put(grammarAccess.getHLScelActionAccess().getGroup_6(), "rule__HLScelAction__Group_6__0");
					put(grammarAccess.getTemplateFieldAccess().getGroup_1(), "rule__TemplateField__Group_1__0");
					...
					put(grammarAccess.getNodeDeclarationAccess().getNameAssignment_1(), "rule__NodeDeclaration__NameAssignment_1");
					put(grammarAccess.getNodeDeclarationAccess().getArgsAssignment_3_0(), "rule__NodeDeclaration__ArgsAssignment_3_0");
					put(grammarAccess.getNodeDeclarationAccess().getArgsAssignment_3_1_1(), "rule__NodeDeclaration__ArgsAssignment_3_1_1");
					put(grammarAccess.getProcessDeclarationAccess().getNameAssignment_1(), "rule__ProcessDeclaration__NameAssignment_1");
					put(grammarAccess.getProcessDeclarationAccess().getArgsAssignment_3_0(), "rule__ProcessDeclaration__ArgsAssignment_3_0");
					put(grammarAccess.getProcessDeclarationAccess().getArgsAssignment_3_1_1(), "rule__ProcessDeclaration__ArgsAssignment_3_1_1");
					put(grammarAccess.getProcessDeclarationAccess().getBodyAssignment_5(), "rule__ProcessDeclaration__BodyAssignment_5");
					put(grammarAccess.getHLScelPredicateAccess().getExpAssignment_1(), "rule__HLScelPredicate__ExpAssignment_1");
					put(grammarAccess.getHLScelActionAccess().getFeatureCallArgumentsAssignment_0_3(), "rule__HLScelAction__FeatureCallArgumentsAssignment_0_3");
					put(grammarAccess.getHLScelActionAccess().getFeatureCallArgumentsAssignment_0_4_1(), "rule__HLScelAction__FeatureCallArgumentsAssignment_0_4_1");
					put(grammarAccess.getHLScelActionAccess().getTargetAssignment_0_7(), "rule__HLScelAction__TargetAssignment_0_7");
					put(grammarAccess.getHLScelActionAccess().getFieldsAssignment_1_3(), "rule__HLScelAction__FieldsAssignment_1_3");
					put(grammarAccess.getHLScelActionAccess().getFieldsAssignment_1_4_1(), "rule__HLScelAction__FieldsAssignment_1_4_1");
					put(grammarAccess.getHLScelActionAccess().getTargetAssignment_1_7(), "rule__HLScelAction__TargetAssignment_1_7");
					put(grammarAccess.getHLScelActionAccess().getFieldsAssignment_2_3(), "rule__HLScelAction__FieldsAssignment_2_3");
					put(grammarAccess.getHLScelActionAccess().getFieldsAssignment_2_4_1(), "rule__HLScelAction__FieldsAssignment_2_4_1");
					put(grammarAccess.getHLScelActionAccess().getTargetAssignment_2_7(), "rule__HLScelAction__TargetAssignment_2_7");
					put(grammarAccess.getHLScelActionAccess().getFieldsAssignment_3_3(), "rule__HLScelAction__FieldsAssignment_3_3");
					put(grammarAccess.getHLScelActionAccess().getFieldsAssignment_3_4_1(), "rule__HLScelAction__FieldsAssignment_3_4_1");
					put(grammarAccess.getHLScelActionAccess().getTargetAssignment_3_7(), "rule__HLScelAction__TargetAssignment_3_7");
					put(grammarAccess.getHLScelActionAccess().getFieldsAssignment_4_3(), "rule__HLScelAction__FieldsAssignment_4_3");
					put(grammarAccess.getHLScelActionAccess().getFieldsAssignment_4_4_1(), "rule__HLScelAction__FieldsAssignment_4_4_1");
					put(grammarAccess.getHLScelActionAccess().getTargetAssignment_4_7(), "rule__HLScelAction__TargetAssignment_4_7");
					put(grammarAccess.getHLScelActionAccess().getArgAssignment_5_3(), "rule__HLScelAction__ArgAssignment_5_3");
					put(grammarAccess.getHLScelActionAccess().getTargetAssignment_5_6(), "rule__HLScelAction__TargetAssignment_5_6");
					put(grammarAccess.getHLScelActionAccess().getArgAssignment_6_3(), "rule__HLScelAction__ArgAssignment_6_3");
					put(grammarAccess.getTemplateFieldAccess().getReferenceAssignment_1_2(), "rule__TemplateField__ReferenceAssignment_1_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.cmg.resp.xtext.hlscel.ui.contentassist.antlr.internal.InternalHLScelParser typedParser = (org.cmg.resp.xtext.hlscel.ui.contentassist.antlr.internal.InternalHLScelParser) parser;
