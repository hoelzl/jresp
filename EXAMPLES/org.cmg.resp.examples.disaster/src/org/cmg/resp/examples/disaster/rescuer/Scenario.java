...
public class Scenario extends Observable {
	...
	//number of Rescuers need to save a victim
	private int sizeOfRescuers;

	private int numberOfRobots;

	private int numberOfVictims;

	public Scenario( int numberOfRobots , int sizeOfRescuers , int numberOfVictims , double height , double width ) {
		this.numberOfRobots = numberOfRobots;
		this.sizeOfRescuers = sizeOfRescuers;
...
//			detectVictims();
	...
	public int getRescuersSize() {
		return sizeOfRescuers;
	}
