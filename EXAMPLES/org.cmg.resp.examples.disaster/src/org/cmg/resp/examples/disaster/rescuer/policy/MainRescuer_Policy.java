 ...
 *
 */
public class MainRescuer_Policy extends JFrame {
	...
	public MainRescuer_Policy( int robots , int numSwarmRescuer , double height , double width  ) {
...
//					);
	...
	public static void main( String[] argv ) {
		...
		new MainRescuer_Policy( numRobots , numRescuerSwarmSize , HEIGHT , WIDTH );
	}
